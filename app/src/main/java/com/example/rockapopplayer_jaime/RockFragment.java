...
public class RockFragment extends Fragment {
 ...
 // Constantof the base URL of the API
    ...
    ArrayList<DataListRock> datalistRocks = new ArrayList<>();


    RecyclerView recList;
    RVAdapterRock RVadapter=new RVAdapterRock(datalistRocks);
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        recList =  v.findViewById(R.id.rock_recyclerview);
    ...
    InterfaceAPI_Rock interfaceAPI_rock = retrofit.create(InterfaceAPI_Rock.class);
    interfaceAPI_rock.getRockMusic().enqueue(new Callback<DataResult>() {
        ...
        public void onResponse(Call<DataResult> call, Response<DataResult> response) {
            ...
            if(response.body().getResults() != null){
                ...
                for(int i = 0 ; i < response.body().getResultCount(); i++){
                    ...
                    datalistRocks.add(new DataListRock(

                            response.body().getResults().get(i).artistName,
                            response.body().getResults().get(i).collectionName,
